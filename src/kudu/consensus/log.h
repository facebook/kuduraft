...
struct RetentionIndexes {
  explicit RetentionIndexes(
      ...
      int64_t regionDurability = std::numeric_limits<int64_t>::max())
      : forDurability(durability),
        forPeers(peers),
        forRegionDurability(regionDurability) {}
